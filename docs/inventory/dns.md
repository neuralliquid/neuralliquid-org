...
| --- | --- | --- | --- | --- |
| Convolens | `convolens.neuralliquid.ai` | `neuralliquid.ai` | Convolens prod frontend App Service | Broken |
...
Convolens and Omnipost must not point at the apex. Each needs:
...
- Convolens declares `convolens.neuralliquid.ai` as a go-live custom hostname but does not yet own DNS/binding in Terraform.
