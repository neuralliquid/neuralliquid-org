...
import {
  ...
  id = "/subscriptions/5a95ddee-dd63-441a-8306-c8b0803dcdd4/resourceGroups/nl-prod-shared-rg/providers/Microsoft.DBforPostgreSQL/flexibleServers/nl-prod-shared-pg"
}

import {
  to = azurerm_postgresql_flexible_server_database.tenant["convolens"]
  id = "/subscriptions/5a95ddee-dd63-441a-8306-c8b0803dcdd4/resourceGroups/nl-prod-shared-rg/providers/Microsoft.DBforPostgreSQL/flexibleServers/nl-prod-shared-pg/databases/convolens"
}

import {
  to = azurerm_postgresql_flexible_server_firewall_rule.allow_azure_services
  id = "/subscriptions/5a95ddee-dd63-441a-8306-c8b0803dcdd4/resourceGroups/nl-prod-shared-rg/providers/Microsoft.DBforPostgreSQL/flexibleServers/nl-prod-shared-pg/firewallRules/AllowAllAzureServicesAndResourcesWithinAzureIps_2026-8-7_2-56-48"
}

import {
  to = azurerm_postgresql_flexible_server_configuration.require_secure_transport
  id = "/subscriptions/5a95ddee-dd63-441a-8306-c8b0803dcdd4/resourceGroups/nl-prod-shared-rg/providers/Microsoft.DBforPostgreSQL/flexibleServers/nl-prod-shared-pg/configurations/require_secure_transport"
}

import {
  to = azurerm_postgresql_flexible_server_configuration.ssl_min_protocol_version
  id = "/subscriptions/5a95ddee-dd63-441a-8306-c8b0803dcdd4/resourceGroups/nl-prod-shared-rg/providers/Microsoft.DBforPostgreSQL/flexibleServers/nl-prod-shared-pg/configurations/ssl_min_protocol_version"
}
